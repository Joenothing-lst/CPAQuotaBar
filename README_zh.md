...
**当前版本：0.4.1 · Apple Silicon · macOS 26.2+ · [MIT License](LICENSE)**
...
- **套餐容量加权**：汇总剩余百分比会按账号套餐的实际容量加权计算：Plus/Team 为 1 倍、Pro 5x / ProLite / Premium 为 5 倍、Pro 20x 为 20 倍；无法识别的套餐按 1 倍处理。账号详情中的百分比仍按该账号自身额度显示。
